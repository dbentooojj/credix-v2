const legacyLinks = [
  ...
  { label: "Painel Financeiro", path: "/admin/dashboard.html" },
  { label: "Clientes", path: "/admin/debtors.html" },
  { label: "Emprestimos", path: "/admin/loans.html" },
];

export default function MigrationGatewayPage() {
  return (
